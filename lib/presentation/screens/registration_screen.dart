  ...
  Widget _registrationForm(context, state) => SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              TextInputField(
                onChanged: (value) => BlocProvider.of<RegistrationBloc>(context)
                    .add(ChangeCreationAccountParameterEvent(
                  userName: value,
              ...
              DirectoryPickerButton(
                onPressed: (value) => BlocProvider.of<RegistrationBloc>(context)
                    .add(ChangeCreationAccountParameterEvent(
                        userName: state.userName,
                        password: state.password,
